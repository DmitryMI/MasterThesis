...
then
    ...
    $SUDO_PREFIX apt -y install openjdk-17-jre bison python3-numpy python3-pandas python3-matplotlib libxerces-c-dev libproj-dev python-dev cmake clang-format uncrustify lldb
fi
