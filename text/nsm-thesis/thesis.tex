...
In conclusion, it is clear that in my scenario the best efficiency of drones is achieved in range \SIrange{150}{350}{\meter}, with peak at \SIrange{150}{200}{\meter}. In the main part of the experiment the drone height parameter is set to \SIrange{150}{200}{\meter} (see \cref{tab:simulationparams}), which is inside this best case range.
