...
\begin{figure}
  	\caption{Example of a right prism. The bases are two equal arbitrary polygons, but the walls are rectangles with equal height. The right prism can be easily imagined via "extruding" a random polygon straight upwards.}
	\centering
