...
echo "#SBATCH --mem-per-cpu=2048" >> eval.jobfile
echo "#SBATCH --time=01:00:00" >> eval.jobfile
...
echo "srun singularity exec -C -H ~/:/root --bind $SCRATCH_WORKSPACE:$SINGULARITY_WORKSPACE_MNT:rw ./ubuntu \"/root/scripts/hpc/singularity-executors/singularity_eval_project.sh\"" >> eval.jobfile
